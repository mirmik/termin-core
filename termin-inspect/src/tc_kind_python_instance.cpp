...
namespace tc {
    ...
    void KindRegistryPython::unregister_type_mappings_for_kind(const std::string& kind_name) {
        _type_to_kind.erase(std::remove_if(_type_to_kind.begin(),
                                           _type_to_kind.end(),
                                           [&kind_name](const auto& item) { return item.second == kind_name; }),
                            _type_to_kind.end());
    }
    ...
    void KindRegistry::register_cpp(const std::string& name,
    ...
    KindRegistryCpp& KindRegistry::cpp() {
        return KindRegistryCpp::instance();
    }
    const KindRegistryCpp& KindRegistry::cpp() const {
        return KindRegistryCpp::instance();
    }

    KindRegistryPython& KindRegistry::python() {
        return KindRegistryPython::instance();
    }
    const KindRegistryPython& KindRegistry::python() const {
        return KindRegistryPython::instance();
    }
