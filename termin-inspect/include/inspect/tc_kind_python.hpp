...
// Python kind handler - uses nb::object for Python callables
    ...
    public:
        ...
        void register_cpp(const std::string& name,
    ...
    inline void bind_kind_registry(nb::module_& m) {
        nb::class_<KindRegistry>(m, "KindRegistry")
            ...
            .def("register_python",
                 ...
                 nb::arg("serialize"),
                 nb::arg("deserialize"))
            .def("unregister_python", &KindRegistry::unregister_python, nb::arg("name"))
            .def(
                "register_type",
                [](KindRegistry& self, nb::handle type, const std::string& kind_name) {
                    self.register_type(type, kind_name);
                },
                nb::arg("type"),
                nb::arg("kind_name"))
            .def("kind_for_object", &KindRegistry::kind_for_object, nb::arg("obj"))
            .def("serialize", &KindRegistry::serialize_python, nb::arg("kind"), nb::arg("obj"))
            .def(
                "deserialize",
                [](KindRegistry& self, const std::string& kind, nb::object data) {
