...
namespace tc {
    ...
    public:
        ...
        nos::trent get(const std::string& key, const nos::trent& default_value) const;
    ...
    private:
        ...
        std::pair<nos::trent*, std::string> _navigate_mut(const std::string& full_key, bool create);

        std::pair<const nos::trent*, std::string> _navigate(const std::string& full_key) const;
    };
} // namespace tc
