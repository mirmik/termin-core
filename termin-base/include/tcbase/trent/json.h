...
namespace nos {
    namespace json {
        ...
        protected:
            ...
            static void append_utf8_codepoint(trent::string_type& out, uint32_t codepoint);
        ...
        public:
            explicit parser_cstr(const char* str)
                : ptr(str) {}
        ...
        public:
            explicit parser_str(const std::string& str)
                : storage(str) {}
            explicit parser_str(std::string&& str)
        ...
        public:
            explicit parser_input_stream(std::istream& is)
                : is(is) {}
