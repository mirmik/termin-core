...
namespace nos {
    ...
    std::string replace(const std::string& src, const std::string& oldsub, const std::string& newsub);
    ...
    std::vector<std::string_view> split_view(const std::string_view& str, const char* delims);
