...
namespace nos {
    template <typename T, typename E> class expected {
        ...
        using err_type = E;
        static constexpr size_t Size = sizeof(ok_type) > sizeof(err_type) ? sizeof(ok_type) : sizeof(err_type);
    ...
    template <typename T, typename E> expected<T, E> make_unexpected(const E& err) {
