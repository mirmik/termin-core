...
namespace nos {
    ...
    template <typename T, typename... Args> void constructor(T* ptr, Args&&... args) {
    ...
    template <class InputIterator, class EndIterator> void array_destructor(InputIterator first, EndIterator last) {
        while (first != last) {
