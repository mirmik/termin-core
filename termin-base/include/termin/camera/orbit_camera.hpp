...
namespace termin {
    ...
    public:
        ...
        OrbitCameraRay screen_ray(float screen_x, float screen_y, float width, float height) const;
        std::optional<Vec3f>
        world_point_on_z_plane(float screen_x, float screen_y, float width, float height, float z = 0.0f) const;
