...
TC_C_STATIC_INLINE tc_screw3 tc_screw3_transform_by(tc_screw3 s, tc_pose3 pose) {
    return TC_SCREW3(
...
TC_C_STATIC_INLINE tc_screw3 tc_screw3_inverse_transform_by(tc_screw3 s, tc_pose3 pose) {
...
TC_C_STATIC_INLINE tc_screw3 tc_screw3_adjoint_arm(tc_screw3 s, tc_vec3 arm) {
...
TC_C_STATIC_INLINE tc_screw3 tc_screw3_adjoint_inv_arm(tc_screw3 s, tc_vec3 arm) {
...
TC_C_STATIC_INLINE tc_screw3 tc_screw3_coadjoint_arm(tc_screw3 s, tc_vec3 arm) {
...
TC_C_STATIC_INLINE tc_screw3 tc_screw3_coadjoint_inv_arm(tc_screw3 s, tc_vec3 arm) {
