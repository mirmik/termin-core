...
TC_C_STATIC_INLINE tc_screw2 tc_screw2_new(double ang, tc_vec2 lin) {
    return TC_SCREW2(ang, lin);
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_zero(void) {
    return TC_SCREW2(0.0, tc_vec2_zero());
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_add(tc_screw2 a, tc_screw2 b) {
    return TC_SCREW2(a.ang + b.ang, tc_vec2_add(a.lin, b.lin));
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_sub(tc_screw2 a, tc_screw2 b) {
    return TC_SCREW2(a.ang - b.ang, tc_vec2_sub(a.lin, b.lin));
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_scale(tc_screw2 s, double k) {
    return TC_SCREW2(s.ang * k, tc_vec2_scale(s.lin, k));
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_neg(tc_screw2 s) {
    return TC_SCREW2(-s.ang, tc_vec2_neg(s.lin));
}

TC_C_STATIC_INLINE tc_vec2 tc_screw2_scalar_cross_vec(double scalar, tc_vec2 vec) {
    return TC_VEC2(scalar * vec.y, -scalar * vec.x);
}

TC_C_STATIC_INLINE tc_vec2 tc_screw2_vec_cross_scalar(tc_vec2 vec, double scalar) {
    return TC_VEC2(-scalar * vec.y, scalar * vec.x);
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_kinematic_carry(tc_screw2 s, tc_vec2 arm) {
    return TC_SCREW2(s.ang, tc_vec2_add(s.lin, tc_screw2_scalar_cross_vec(s.ang, arm)));
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_force_carry(tc_screw2 s, tc_vec2 arm) {
    return TC_SCREW2(s.ang - tc_vec2_cross(arm, s.lin), s.lin);
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_transform_by(tc_screw2 s, tc_pose2 pose) {
    return TC_SCREW2(s.ang, tc_pose2_transform_vector(pose, s.lin));
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_inverse_transform_by(tc_screw2 s, tc_pose2 pose) {
    return TC_SCREW2(s.ang, tc_pose2_inverse_transform_vector(pose, s.lin));
}

TC_C_STATIC_INLINE tc_screw2 tc_screw2_transform_as_twist_by(tc_screw2 s, tc_pose2 pose) {
...
TC_C_STATIC_INLINE tc_screw2 tc_screw2_inverse_transform_as_twist_by(tc_screw2 s, tc_pose2 pose) {
