    ...
    namespace {
        ...
        template <typename BoundsT, typename ScalarT> void bind_bounds2_type(nb::module_& m, const char* name) {
            nb::class_<BoundsT>(m, name)
                ...
                .def("__getitem__",
                     [](const BoundsT& b, int i) {
                         ...
                         case 3:
                             return b.y1;
                         default:
                             throw nb::index_error("Bounds2 index out of range");
                         }
                     })
                .def("__setitem__",
                     [](BoundsT& b, int i, ScalarT val) {
                         switch (i) {
                         case 0:
                             b.x0 = val;
                             return;
                ...
                .def("__iter__", [](const BoundsT& b) { return nb::iter(nb::make_tuple(b.x0, b.y0, b.x1, b.y1)); })
                .def("tolist",
                     [](const BoundsT& b) {
                         nb::list lst;
                         lst.append(b.x0);
                ...
                .def("__eq__",
                     [](const BoundsT& a, const BoundsT& b) {
