    ...
    void bind_general_pose3(nb::module_& m) {
        nb::class_<GeneralPose3>(m, "GeneralPose3")
            ...
            .def("compose_trs_projected",
                 nb::overload_cast<const GeneralPose3&>(&GeneralPose3::compose_trs_projected, nb::const_),
                 nb::arg("child"),
                 "Compose and project the affine result back to TRS; may lose shear.")
            .def("compose_trs_projected",
                 nb::overload_cast<const Pose3&>(&GeneralPose3::compose_trs_projected, nb::const_),
                 nb::arg("child"),
                 "Compose and project the affine result back to TRS; may lose shear.")
            ...
            .def("inverse_transform_point",
                 nb::overload_cast<const Vec3&>(&GeneralPose3::inverse_transform_point, nb::const_))
            .def("inverse_transform_vector",
                 nb::overload_cast<const Vec3&>(&GeneralPose3::inverse_transform_vector, nb::const_))
            .def("inverse_transform_direction",
                 nb::overload_cast<const Vec3&>(&GeneralPose3::inverse_transform_direction, nb::const_))
