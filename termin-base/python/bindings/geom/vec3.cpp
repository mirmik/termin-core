...
namespace termin {
    ...
    void bind_vec3(nb::module_& m) {
        nb::class_<Vec3>(m, "Vec3")
            ...
            .def("__init__", [](Vec3* self, nb::object obj) { new (self) Vec3(sequence_to_vec3(obj)); })
            .def_rw("x", &Vec3::x)
            .def_rw("y", &Vec3::y)
            .def_rw("z", &Vec3::z)
            ...
            .def("__iter__", [](const Vec3& v) { return nb::iter(nb::make_tuple(v.x, v.y, v.z)); })
            .def(nb::self + nb::self)
            .def(nb::self - nb::self)
            .def(nb::self * double())
            .def(double() * nb::self)
            ...
            .def_static("angle", &Vec3::angle, nb::arg("a"), nb::arg("b"), "Angle between two vectors in radians")
            .def_static("angle_degrees",
                        &Vec3::angle_degrees,
                        nb::arg("a"),
                        nb::arg("b"),
            ...
            .def("__eq__", [](const Vec3& a, const Vec3& b) { return a.x == b.x && a.y == b.y && a.z == b.z; })
            .def("__ne__", [](const Vec3& a, const Vec3& b) { return a.x != b.x || a.y != b.y || a.z != b.z; })
            .def(
                "approx_eq",
                [](const Vec3& a, const Vec3& b, double eps) {
        ...
        nb::class_<Vec3f>(m, "Vec3f")
            ...
            .def("__init__", [](Vec3f* self, nb::object obj) { new (self) Vec3f(sequence_to_vec3f(obj)); })
            .def_rw("x", &Vec3f::x)
            .def_rw("y", &Vec3f::y)
            .def_rw("z", &Vec3f::z)
            ...
            .def("__iter__", [](const Vec3f& v) { return nb::iter(nb::make_tuple(v.x, v.y, v.z)); })
            .def(nb::self + nb::self)
            .def(nb::self - nb::self)
            .def(nb::self * float())
            .def(float() * nb::self)
            ...
            .def(
                "approx_eq",
                [](const Vec3f& a, const Vec3f& b, float eps) {
                    return std::abs(a.x - b.x) < eps && std::abs(a.y - b.y) < eps && std::abs(a.z - b.z) < eps;
                },
                nb::arg("other"),
                nb::arg("eps") = 1e-6f)
        ...
        nb::class_<Vec3i>(m, "Vec3i")
            ...
            .def("__iter__", [](const Vec3i& v) { return nb::iter(nb::make_tuple(v.x, v.y, v.z)); })
            .def(nb::self + nb::self)
            .def(nb::self - nb::self)
            .def(nb::self * int())
            .def(int() * nb::self)
            ...
            .def("__repr__", [](const Vec3i& v) {
                return "Vec3i(" + std::to_string(v.x) + ", " + std::to_string(v.y) + ", " + std::to_string(v.z) + ")";
            });
    }
