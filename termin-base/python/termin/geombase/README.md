...
#### Pose2
Native-класс для представления позы в 2D пространстве (положение + ориентация).
...
#### Screw
Совместимое имя для native `Screw2`.
...
#### Screw2
Native-винт в 2D пространстве (плоский случай).
