...
namespace termin {
    ...
    public:
        ...
        tc_dispatch_ticket ticket() const noexcept {
            return ticket_;
        }
    ...
    private:
        ...
        DeferredCall(std::weak_ptr<dispatch_detail::DispatcherState> state, tc_dispatch_ticket ticket)
    ...
    public:
        ...
        TERMIN_DISPATCH_API DeferredCall post(tc_dispatch_callback callback,
